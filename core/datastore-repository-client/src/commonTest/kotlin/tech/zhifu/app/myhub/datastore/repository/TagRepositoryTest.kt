...
class TagRepositoryTest {
    ...
    fun `test get popular tags`() = runDatabaseTest { database ->
        ...
        // When - getPopularTags 方法已不存在，使用 observeAllTags 代替
        val flow = repository.observeAllTags()
        val allTags = flow.first()
        val result = allTags.sortedByDescending { it.cardCount }.take(2)
