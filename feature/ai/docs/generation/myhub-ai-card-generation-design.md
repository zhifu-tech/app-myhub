...
> 关联文档：[myhub-app-design.md](../../../../docs/design/myhub-app-design.md) §8.6 New Capture；[myhub-ai-card-generation-product-design.md](myhub-ai-card-generation-product-design.md)（产品摘要）；[myhub-ai-card-generation-backend-design.md](myhub-ai-card-generation-backend-design.md)（后端设计）；[myhub-ai-card-generation-chatgpt-prompt.md](myhub-ai-card-generation-chatgpt-prompt.md)（ChatGPT 提示词）  
