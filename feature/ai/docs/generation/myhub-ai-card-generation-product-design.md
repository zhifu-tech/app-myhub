...
> 文档版本：v1.0  
> 关联文档：[myhub-ai-card-generation-design.md](myhub-ai-card-generation-design.md)（技术详述）、[myhub-ai-card-generation-backend-design.md](myhub-ai-card-generation-backend-design.md)（后端设计）、[myhub-app-design.md](../../../../docs/design/myhub-app-design.md) §8.6 New Capture  
> 适用对象：产品、前端、后端、AI 集成
