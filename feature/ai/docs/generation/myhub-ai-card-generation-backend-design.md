...
> 文档版本：v1.0  
> 关联文档：[myhub-ai-card-generation-design.md](myhub-ai-card-generation-design.md)、[myhub-ai-card-generation-product-design.md](myhub-ai-card-generation-product-design.md)  
> 适用对象：后端、客户端、AI 集成
