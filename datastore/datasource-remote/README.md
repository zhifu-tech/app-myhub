...
```bash
# 运行所有平台的测试
./gradlew :datastore:datasource-remote:allTests

# 运行特定平台的测试
./gradlew :datastore:datasource-remote:jvmTest
./gradlew :datastore:datasource-remote:jsTest
./gradlew :datastore:datasource-remote:iosSimulatorArm64Test
```
