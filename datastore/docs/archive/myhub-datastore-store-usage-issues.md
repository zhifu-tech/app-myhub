...
>
> 相关文档：[Store5 架构设计及使用指南](../myhub-datastore-store5-architecture-guide.md)、[Store 设计问题分析与优化建议](./myhub-datastore-store-design-analysis.md)
...
| 低   | 文档明确「例外读路径」                             | ✅ 已落地 | 见 [Datasource 使用梳理及与 Store 的关系](../myhub-datastore-datasource-usage-and-store.md) 第 3.2 节。                                                                                                                                            |
