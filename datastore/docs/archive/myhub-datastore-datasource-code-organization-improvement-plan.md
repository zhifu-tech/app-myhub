...
>
> 相关：[Datasource 使用梳理及与 Store 的关系](../myhub-datastore-datasource-usage-and-store.md)
...
与 [Store 使用问题与纠正说明](./myhub-datastore-store-usage-issues.md) 第 2 节（SourceOfTruth reader 语义）对应，需在 Local 层补齐可观察 API。
