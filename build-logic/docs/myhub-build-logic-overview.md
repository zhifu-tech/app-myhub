...
这个模块用于**规范**和**实现** MyHub 项目的构建约定插件，为各模块**提供统一、可复用的构建配置能力**。它基于 **Gradle Kotlin DSL**，封装了常用的 KMP、Android、Compose 和序列化约定，方便在 **各业务模块** 中统一接入和维护。
...
- [MyHub 构建文件规则](./myhub-build-file-rules.md)
- [MyHub 构建变体说明](./BUILD_VARIANTS.md)
