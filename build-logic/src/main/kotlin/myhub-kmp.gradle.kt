 ...
 *
 * @return true 如果是 Google Play 渠道
 *
 * @sample
 * ```kotlin
 ...
 * ```
 */
fun Project.isGooglePlay(): Boolean {
    return isChannel("googlePlay")
}

/**
 * 判断当前是否为 Umeng 渠道
 *
 * @return true 如果是 Umeng 渠道
 *
 * @sample
 * ```kotlin
 * if (project.isUmeng()) {
 ...
 * ```
 */
fun Project.isUmeng(): Boolean {
    return isChannel("umeng")
}

/**
 * 判断当前是否为 Vivo 渠道
 *
 * @return true 如果是 Vivo 渠道
 *
 * @sample
 * ```kotlin
 * if (project.isVivo()) {
 ...
 * ```
 */
fun Project.isVivo(): Boolean {
    return isChannel("vivo")
}

/**
 * 判断当前是否为 OPPO 渠道
 *
 * @return true 如果是 OPPO 渠道
 *
 * @sample
 * ```kotlin
 * if (project.isOppo()) {
 ...
 * ```
 */
fun Project.isOppo(): Boolean {
    return isChannel("oppo")
}

/**
 * 判断当前是否为 小米 渠道
 *
 * @return true 如果是 小米 渠道
 *
 * @sample
 * ```kotlin
 * if (project.isXiaomi()) {
 ...
 * ```
 */
fun Project.isXiaomi(): Boolean {
    return isChannel("xiaomi")
}

/**
 * 判断当前是否为 华为 渠道
 *
 * @return true 如果是 华为 渠道
 *
 * @sample
 * ```kotlin
 * if (project.isHuawei()) {
 ...
 * ```
 */
fun Project.isHuawei(): Boolean {
    return isChannel("huawei")
}
