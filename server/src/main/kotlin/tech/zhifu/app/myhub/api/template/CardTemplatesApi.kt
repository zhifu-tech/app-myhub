package tech.zhifu.app.myhub.api.template
 ...
 */
fun Route.cardTemplatesApi() {
    authenticate("auth-bearer") {
        route("/api/templates") {
            get {
                val templateService = call.application.get<CardTemplateService>()
                try {
            ...
            get("{id}") {
                val templateService = call.application.get<CardTemplateService>()
                try {
                    val id = call.parameters["id"] ?: throw ValidationException("Template ID is required")
