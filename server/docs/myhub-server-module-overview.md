...
- [环境变量配置指南](docs/myhub-server-environment-variables.md)
- [JWT 配置指南](docs/myhub-server-jwt-setup-guide.md)
- [JWT 认证实现文档](docs/myhub-server-jwt-authentication-implementation.md)
...
Server 支持 SQLite 和 PostgreSQL 两种数据库。详细配置说明请参考 [数据库配置文档](docs/myhub-server-database.md)。
...
├── README.md
└── docs/
    ├── myhub-server-architecture.md
    ├── archive/myhub-server-module-review.md
    └── ...
```

## 🔗 相关文档

- [架构设计文档](docs/myhub-server-architecture.md) - 详细的架构设计和实现说明
- [模块入口](../README.md) - 模块文档入口
