...
>
> 相关： [Store5 架构设计及使用指南](./store5-architecture-guide.md)、[Store 使用问题与纠正说明](./store-usage-issues.md)
...
| **例外**             | 衍生/统计类读（如 getReviewProgress）、同步协议与 Outbox/OpLog、认证（Auth）等，可不经 Store，直接使用对应 DataSource；详细列表与原因见 [Store 使用问题与纠正说明](./store-usage-issues.md)。 |
...
| TagStore        | LocalTagDataSource                        | RemoteTagDataSource                                                      |
| UserStore       | LocalUserDataSource                       | RemoteUserDataSource                                                     |
| CollectionStore | LocalCollectionDataSource                 | RemoteCollectionDataSource                                               |
| TemplateStore   | LocalCardTemplateDataSource               | RemoteCardTemplateDataSource                                             |
...
- [Store5 架构设计及使用指南](./store5-architecture-guide.md)
